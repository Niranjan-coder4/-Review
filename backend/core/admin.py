...
from .models import User, Course, Assignment, Submission, Feedback, PlagiarismReport, ExportJob
...
class CourseAdmin(admin.ModelAdmin):
    list_display = ('code', 'name', 'instructor', 'get_student_count', 'is_active', 'created_at')
...
class AssignmentAdmin(admin.ModelAdmin):
    list_display = ('title', 'course', 'instructor', 'due_date', 'created_at')
    list_filter = ('instructor', 'course', 'created_at')
